...
### 主界面
![主界面截图](freeroom/screenshots/main-interface.png "FreeRoom 主界面")

### 加密聊天界面
![加密聊天界面截图](freeroom/screenshots/encrypt-chat.png "加密聊天界面")
...
1. **克隆或下载项目**
   ```bash
   git clone https://github.com/bluecap666/freeroom.git
   ```
...
查看 [TODO.md](freeroom/TODO.md) 了解项目开发进度和未来计划。

## 🤝 贡献指南

查看 [CONTRIBUTING.md](freeroom/CONTRIBUTING.md) 了解如何为项目做贡献。

## 📄 更新日志

查看 [CHANGELOG.md](freeroom/CHANGELOG.md) 了解项目更新历史。
